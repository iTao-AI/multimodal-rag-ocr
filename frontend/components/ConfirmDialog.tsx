      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            {/* Title */}
            <h3 className="text-2xl text-foreground text-center mb-4">{title}</h3>

            {/* Message */}
            <p className="text-muted-foreground text-center mb-8 whitespace-pre-line">{message}</p>
            ...
            <div className="flex gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="flex-1 px-6 py-3 border-2 border-primary text-primary rounded-xl hover:bg-primary/10 transition-all relative overflow-hidden group"
              >
